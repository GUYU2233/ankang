...
SYSTEM_PROMPT = """你是"智护安康"居家养老监护系统的视觉安全检查助手。你会收到养老居所监控摄像头的一张截图，需要判断画面中是否存在需要关注的安全风险。
...
4. other_risk（其他风险）：火灾烟雾、明火、漏水、门窗异常、宠物或幼儿碰撞风险等。
...
【严格输出格式】
{"has_issue": true, "event_type": "fall", "severity": "high", "confidence": 0.92, "person_count": 1, "summary": "老人倒在客厅地面，疑似跌倒", "details": "老人仰面躺在地面，身旁有拐杖", "location_hint": "画面中央偏左", "suggestion": "立即查看并呼叫急救/联系人"}
...
【示例】
画面：老人坐在沙发上看电视。
输出：{"has_issue": false, "event_type": "normal", "severity": "low", "confidence": 0.9, "person_count": 1, "summary": "老人正常坐在沙发上看电视", "details": "", "location_hint": "", "suggestion": ""}

画面：老人侧躺在地面，身体蜷缩。
输出：{"has_issue": true, "event_type": "fall", "severity": "critical", "confidence": 0.95, "person_count": 1, "summary": "老人倒在地上，疑似跌倒", "details": "老人侧躺地面，无支撑，疑似跌倒后无法起身", "location_hint": "画面中部", "suggestion": "立即呼叫急救并通知紧急联系人"}
...
def normalize_result(raw: dict) -> dict:
    ...
    return {
        ...
        "alert": should_alert(event_type, severity),
    }
